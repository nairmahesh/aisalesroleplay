...
export function AIRoleplayView() {
  ...
  if (activeCallBot) {
    return <CallRoomView bot={activeCallBot} practiceMode="ai_roleplay" onEndCall={handleEndCall} />;
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-slate-900 mb-2">AI Role Play</h1>
        <p className="text-slate-600">
          Practice with an AI version of the prospect. Select a bot to start an interactive conversation.
        </p>
      </div>
